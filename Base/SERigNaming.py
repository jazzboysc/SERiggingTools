...
sFaceProxyJointControlsGroup      = 'FaceProxyControlGrp'
sFaceProxyJointControlRivetsGroup = 'FaceProxyControlRivetsGrp'

sFacialComponentAttr    = 'FacialComponent'
sNeckComponentAttr      = 'NeckComponent'
sRightHandComponentAttr = 'RightHandComponent' 
sLeftHandComponentAttr  = 'LeftHandComponent'
sRightArmComponentAttr  = 'RightArmComponent'
sLeftArmComponentAttr   = 'LeftArmComponent'
sRightLegComponentAttr  = 'RightLegComponent'
sLeftLegComponentAttr   = 'LeftLegComponent'
...
sMasterJointsGroupAttr                     = 'MasterJointsGroup'
sMasterJointsGroupOwnerAttr                = 'MasterJointsGroupOwner'
sModelGroupAttr                            = 'ModelGroup'
sModelGroupOwnerAttr                       = 'ModelGroupOwner'
sFaceProxyControlGroupAttr                 = 'FaceProxyControlGroup'
sFaceProxyControlGroupOwnerAttr            = 'FaceProxyControlGroupOwner'
sFaceProxyControlRivetGroupAttr            = 'FaceProxyControlRivetGroup'
sFaceProxyControlRivetGroupOwnerAttr       = 'FaceProxyControlRivetGroupOwner'
...
sRigPartsFixedGroupAttr = 'RigPartsFixedGroup'
...
dataBufferAUsToBlendshapeAUsTable[sAU_01_L_Attr]         = 'AU_01_L'
dataBufferAUsToBlendshapeAUsTable[sAU_01_R_Attr]         = 'AU_01_R'
dataBufferAUsToBlendshapeAUsTable[sAU_02_L_Attr]         = 'AU_02_L'
dataBufferAUsToBlendshapeAUsTable[sAU_02_R_Attr]         = 'AU_02_R'
dataBufferAUsToBlendshapeAUsTable[sAU_04_L_Attr]         = 'AU_04_L'
dataBufferAUsToBlendshapeAUsTable[sAU_04_R_Attr]         = 'AU_04_R'
dataBufferAUsToBlendshapeAUsTable[sAU_05_L_Attr]         = ''
dataBufferAUsToBlendshapeAUsTable[sAU_05_R_Attr]         = ''
dataBufferAUsToBlendshapeAUsTable[sAU_06_L_Attr]         = ''
dataBufferAUsToBlendshapeAUsTable[sAU_06_R_Attr]         = ''
dataBufferAUsToBlendshapeAUsTable[sAU_07_L_Attr]         = ''
dataBufferAUsToBlendshapeAUsTable[sAU_07_R_Attr]         = ''
dataBufferAUsToBlendshapeAUsTable[sAU_09_L_Attr]         = 'AU_09_L'
dataBufferAUsToBlendshapeAUsTable[sAU_09_R_Attr]         = 'AU_09_R'
dataBufferAUsToBlendshapeAUsTable[sAU_10_L_Attr]         = 'AU_10_L'
dataBufferAUsToBlendshapeAUsTable[sAU_10_R_Attr]         = 'AU_10_R'
dataBufferAUsToBlendshapeAUsTable[sAU_11_L_Attr]         = 'AU_11_L'
dataBufferAUsToBlendshapeAUsTable[sAU_11_R_Attr]         = 'AU_11_R'
dataBufferAUsToBlendshapeAUsTable[sAU_12_L_Attr]         = 'AU_12_L'
dataBufferAUsToBlendshapeAUsTable[sAU_12_R_Attr]         = 'AU_12_R'
dataBufferAUsToBlendshapeAUsTable[sAU_12_OL_Attr]        = ''
dataBufferAUsToBlendshapeAUsTable[sAU_12_OR_Attr]        = ''
dataBufferAUsToBlendshapeAUsTable[sAU_12_Blink_L_Attr]   = ''
dataBufferAUsToBlendshapeAUsTable[sAU_12_Blink_R_Attr]   = ''
dataBufferAUsToBlendshapeAUsTable[sAU_13_L_Attr]         = 'AU_13_L'
dataBufferAUsToBlendshapeAUsTable[sAU_13_R_Attr]         = 'AU_13_R'
dataBufferAUsToBlendshapeAUsTable[sAU_14_L_Attr]         = 'AU_14_L'
dataBufferAUsToBlendshapeAUsTable[sAU_14_R_Attr]         = 'AU_14_R'
dataBufferAUsToBlendshapeAUsTable[sAU_15_L_Attr]         = 'AU_15_L'
dataBufferAUsToBlendshapeAUsTable[sAU_15_R_Attr]         = 'AU_15_R'
dataBufferAUsToBlendshapeAUsTable[sAU_16_L_Attr]         = 'AU_16_L'
dataBufferAUsToBlendshapeAUsTable[sAU_16_R_Attr]         = 'AU_16_R'
dataBufferAUsToBlendshapeAUsTable[sAU_17_D_Attr]         = 'AU_17_D'
dataBufferAUsToBlendshapeAUsTable[sAU_17_U_Attr]         = 'AU_17_U'
dataBufferAUsToBlendshapeAUsTable[sAU_18_L_Attr]         = 'AU_18_L'
dataBufferAUsToBlendshapeAUsTable[sAU_18_R_Attr]         = 'AU_18_R'
dataBufferAUsToBlendshapeAUsTable[sAU_20_L_Attr]         = 'AU_20_L'
dataBufferAUsToBlendshapeAUsTable[sAU_20_R_Attr]         = 'AU_20_R'
dataBufferAUsToBlendshapeAUsTable[sAU_20_NL_Attr]        = ''
dataBufferAUsToBlendshapeAUsTable[sAU_20_NR_Attr]        = ''
dataBufferAUsToBlendshapeAUsTable[sAU_22_D_Attr]         = 'AU_22_D'
dataBufferAUsToBlendshapeAUsTable[sAU_22_U_Attr]         = 'AU_22_U'
dataBufferAUsToBlendshapeAUsTable[sAU_23_D_Attr]         = 'AU_23_D'
dataBufferAUsToBlendshapeAUsTable[sAU_23_U_Attr]         = 'AU_23_U'
dataBufferAUsToBlendshapeAUsTable[sAU_24_Attr]           = ''
dataBufferAUsToBlendshapeAUsTable[sAU_25_D_Attr]         = 'AU_25_D'
dataBufferAUsToBlendshapeAUsTable[sAU_25_U_Attr]         = 'AU_25_U'
dataBufferAUsToBlendshapeAUsTable[sAU_26_Fix_Attr]       = 'AU_26_Fix'
dataBufferAUsToBlendshapeAUsTable[sAU_26_CloseFix_Attr]  = ''
dataBufferAUsToBlendshapeAUsTable[sAU_28_D_Attr]         = 'AU_28_D'
dataBufferAUsToBlendshapeAUsTable[sAU_28_U_Attr]         = 'AU_28_U'
dataBufferAUsToBlendshapeAUsTable[sAU_Puff_L_Attr]       = 'AU_Puff_L'
dataBufferAUsToBlendshapeAUsTable[sAU_Puff_R_Attr]       = 'AU_Puff_R'
dataBufferAUsToBlendshapeAUsTable[sAU_Shrink_L_Attr]     = 'AU_Shrink_L'
dataBufferAUsToBlendshapeAUsTable[sAU_Shrink_R_Attr]     = 'AU_Shrink_R'
dataBufferAUsToBlendshapeAUsTable[sAU_Blink_L_Attr]      = ''
dataBufferAUsToBlendshapeAUsTable[sAU_Blink_R_Attr]      = ''
dataBufferAUsToBlendshapeAUsTable[sAU_Throat_Attr]       = ''
dataBufferAUsToBlendshapeAUsTable[sAU_JawForward_Attr]   = ''
dataBufferAUsToBlendshapeAUsTable[sAU_LipClose_Attr]         = ''
dataBufferAUsToBlendshapeAUsTable[sAU_LowLipCompress_Attr]   = ''
dataBufferAUsToBlendshapeAUsTable[sAU_UpLipCompress_Attr]    = ''
dataBufferAUsToBlendshapeAUsTable[sAU_Eye_L_LookLeft_Attr]   = ''
dataBufferAUsToBlendshapeAUsTable[sAU_Eye_L_LookRight_Attr]  = ''
dataBufferAUsToBlendshapeAUsTable[sAU_Eye_L_LookUp_Attr]     = ''
dataBufferAUsToBlendshapeAUsTable[sAU_Eye_L_LookDown_Attr]   = ''
dataBufferAUsToBlendshapeAUsTable[sAU_Eye_R_LookLeft_Attr]   = ''
dataBufferAUsToBlendshapeAUsTable[sAU_Eye_R_LookRight_Attr]  = ''
dataBufferAUsToBlendshapeAUsTable[sAU_Eye_R_LookUp_Attr]     = ''
dataBufferAUsToBlendshapeAUsTable[sAU_Eye_R_LookDown_Attr]   = ''
dataBufferAUsToBlendshapeAUsTable[sAU_10_OL_Attr]            = 'AU_10_OL'
dataBufferAUsToBlendshapeAUsTable[sAU_10_OR_Attr]            = 'AU_10_OR'
dataBufferAUsToBlendshapeAUsTable[sAU_Eye_L_LookLeft_Blink_Attr]    = 'AU_EyeLookLeftBlink_L'
dataBufferAUsToBlendshapeAUsTable[sAU_Eye_L_LookRight_Blink_Attr]   = 'AU_EyeLookRightBlink_L'
dataBufferAUsToBlendshapeAUsTable[sAU_Eye_L_LookUp_Blink_Attr]      = 'AU_EyeLookUpBlink_L'
dataBufferAUsToBlendshapeAUsTable[sAU_Eye_L_LookDown_Blink_Attr]    = 'AU_EyeLookDownBlink_L'
dataBufferAUsToBlendshapeAUsTable[sAU_Eye_R_LookLeft_Blink_Attr]    = 'AU_EyeLookLeftBlink_R'
dataBufferAUsToBlendshapeAUsTable[sAU_Eye_R_LookRight_Blink_Attr]   = 'AU_EyeLookRightBlink_R'
dataBufferAUsToBlendshapeAUsTable[sAU_Eye_R_LookUp_Blink_Attr]      = 'AU_EyeLookUpBlink_R'
dataBufferAUsToBlendshapeAUsTable[sAU_Eye_R_LookDown_Blink_Attr]    = 'AU_EyeLookDownBlink_R'
